...
$this->params['breadcrumbs'][] = $productName;
?>
...
<div class="product-view">
    ...
    <p>
        ...
        <?php endif; ?>
        <?= Html::a('Обновить', ['update', 'id' => $product->id], ['class' => 'btn btn-primary']) ?>
        ...
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <br />
                    <p>
                        <?= Html::a('Изменить цену', ['price', 'id' => $product->id], ['class' => 'btn btn-success']) ?>
        ...
        <div class="box-body">
            ...
            <?php $form = ActiveForm::begin([
                ...
                <?= $form->field($photosForm, 'files[]')
                    ->label(false)->widget(FileInput::class,
                        [
                            'options' =>
                            [
                                'accept' => 'image/*',
